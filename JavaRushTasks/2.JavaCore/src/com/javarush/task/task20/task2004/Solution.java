...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            try(PrintWriter bufferedWriter = new PrintWriter(new OutputStreamWriter(outputStream))){
                bufferedWriter.println(staticString);
                bufferedWriter.println(i);
                bufferedWriter.println(j);
            }
