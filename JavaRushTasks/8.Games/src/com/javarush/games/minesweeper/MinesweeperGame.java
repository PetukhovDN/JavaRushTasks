...
public class MinesweeperGame extends Game {
    ...
    private void openTile(int x, int y) {
        ...
        if (!isGameStopped && !go.isFlag && !go.isOpen) {
            go.isOpen = true;
    ...
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.BLACK, "Лузер", Color.CHARTREUSE, 90);
    }

    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.DARKBLUE, "ПОБЕДА", Color.LEMONCHIFFON, 90);
    }
